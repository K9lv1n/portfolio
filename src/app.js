(function () {
  ...
  function ProjectCard(props){var p=props.project;return e('article',{className:'project-card reveal'},e('a',{className:'project-image',href:p.href},e('img',{src:p.image,alt:p.alt,loading:'lazy'}),e('span',{className:'project-number'},p.index)),e('div',{className:'project-body'},e('p',{className:'project-kicker'},p.title),e('div',{className:'project-title-row'},e('h3',null,p.subtitle),e('a',{href:p.href,className:'round-link','aria-label':'Open '+p.title},e(Icon,{name:'arrow',size:15}))),e('p',{className:'project-description'},p.description),e('div',{className:'project-stack'},p.stack.map(function(n){return e(TechPill,{key:n,name:n})}))))}
